...
unsigned char PlaceArray[] = { 0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60, 66,
		72, 78 };
...
void LCDInit(unsigned char isVerticalAddresing,unsigned char contrast) { // assume ports set up and initialized to output
	// Reset LCD
